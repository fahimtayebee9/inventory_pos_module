<div class="br-header">
    <div class="br-header-left">
        ...
        <div class="input-group hidden-xs-down wd-340 transition">
    ...
    <div class="br-header-right">
        ...
        <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
                <span class="logged-name hidden-md-down">User Name{{-- {{ Auth::user()->name }} --}}</span>
            ...
            <div class="dropdown-menu dropdown-menu-header wd-250">
                <div class="tx-center">
                    ...
                    <h6 class="logged-fullname">User Name{{-- {{ Auth::user()->name }} --}}</h6> 
                ...
                <ul class="list-unstyled user-profile-nav">
                    <li><a href=" {{--{{ route('user.profile', Auth::user()->slug) }} --}}"><i class="icon ion-ios-person"></i> Edit Profile</a></li>
